...
class BaseTask(object):
    ...
    def make_inputs(self, num_dupices=1):
        ...
        if self.cfg['METHOD'] == 'CASIA':
            ...
            crop_transform = transforms.RandomResizedCrop(size=(112, 112),
                                                          scale=(0.2, 1.0), 
            ...
            transform = [before_crop_transform, crop_transform, after_crop_transform]
            ds = CASIADataset(self.cfg['DATA_ROOT'], ds_names, transform, num_duplices=num_dupices, AdaFace_augment_prob = self.cfg['AdaFace_augment_prob'], clean_txt = self.cfg['CASIA_clean_txt_path'])
            ...
            transform = [before_crop_transform, crop_transform, after_crop_transform]
            ds = TF_SyntheticDataset(self.cfg['DATA_ROOT'], ds_names, transform, num_duplices=num_dupices, AdaFace_augment_prob = self.cfg['AdaFace_augment_prob'])
        else:
