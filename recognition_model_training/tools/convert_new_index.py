...
def parse_args():
    ...
    parser.add_argument('--old', default="../../dataset/Syn_data/TFR_trainging_data/Syn_10k.index", type=str,
                        help='path to old training list')
    parser.add_argument('--tfr_index' ,default="../../dataset/Syn_data/TFR_trainging_data/Syn_10k.index",type=str,
                        help='path to tfrecord index file')
    parser.add_argument('--new', default="../../dataset/Syn_data/TFR_trainging_data/Syn_10k.txt", type=str, 
